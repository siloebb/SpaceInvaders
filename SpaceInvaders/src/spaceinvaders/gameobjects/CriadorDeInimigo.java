 ...
 *
 * @author Bianca
 * Super deselegante  e acoplado isso aqui
 * gera inimigos randomicos em posições randomicas
 * classe para testar a implementação da funcionalidade
 * 
 */
public class CriadorDeInimigo extends GameObject {
    private Resolucao resolucao;
    private Jogo jogo;
    int time;

    public CriadorDeInimigo(Resolucao resolucao, Jogo jogo) {
